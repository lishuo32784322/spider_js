...
rsaFingerprint = function(a, b) {
    var c = '{"user_agent":"Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/77.0.3865.120 Safari/5","language":"zh-CN","color_depth":"24","pixel_ratio":"1","hardware_concurrency":"6","resolution":"1920,1080","available_resolution":"1920,1053","timezone_offset":"-480","session_storage":"1","local_storage":"1","indexed_db":"1","open_database":"1","cpu_class":"unknown","navigator_platform":"Linux x86_64","do_not_track":"unknown","regular_plugins":"Chrome PDF Plugin::Portable Document Format::application/x-google-chrome-pdf~pdf,Chrome PDF Viewer::","webgl_vendor":"Google Inc.~Google SwiftShader","adblock":"false","has_lied_languages":"false","has_lied_resolution":"false","has_lied_os":"false","has_lied_browser":"false","touch_support":"0,false,false","js_fonts":"Arial,Arial Black,Arial Hebrew,Arial MT,Arial Rounded MT Bold,Arial Unicode MS,Book Antiqua,Bookman "}'
        , d = 'a2638903f3550254468b26633da1b33a'
        , e = c.length
        , f = ""
        , g = new RSAKey;
    g.setPublic(a, b);
...
function get_pwd(pwd) {
    var a = {"result":{"publicExponent":"010001","modulus":""}}
    c = new RSAKey;
    c.setPublic(a.result.modulus, a.result.publicExponent);
    var d = c.encrypt(pwd);
    var result = rsaFingerprint(a.result.modulus, a.result.publicExponent)
    fingerPrint = result.result
    fingerPrintDetail = result.details
    return d+'*#*#*'+fingerPrint+'*#*#*'+fingerPrintDetail
}
